 ...
 <div class="mws-panel grid_8 mws-collapsible">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody>
                             <?php if(is_array($list)): foreach($list as $key=>$lists): ?><tr>
                                    <td><?php echo ($lists["id"]); ?></td>
                                    <td><?php echo ($lists["links_id"]); ?></td>
                                    <td><?php echo ($lists["links"]); ?></td>
                                    
                                    <td><span class="badge badge-info">A</span></td>
                                    <td>
                                        <span class="btn-group">
                                           
                                            <a href="/bmw/admin.php/LinksList/mod/id/<?php echo ($lists["id"]); ?>" class="btn btn-small"><i class="icol-disconnect"></i></a>
                                            <a href="/bmw/admin.php/LinksList/del/id/<?php echo ($lists["id"]); ?>" class="btn btn-small"><i class="icol-cancel"></i></a>
                                        </span>
                                    </td>
                                        ...
                                        <tr style="background:#000;"><td colspan="5"><?php echo ($show); ?></td></tr>
