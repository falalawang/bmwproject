			...
			<div class='container'>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
							...
							<?php if(is_array($models)): foreach($models as $key=>$models): ?><tbody>
                                <tr align='center'>
                                    <td><?php echo ($models["id"]); ?></td>
                                    <td><?php echo ($models["name"]); ?></td>
                                    <td><?php echo ($models["carName"]); ?></td>		
                                    <td><?php echo ($models["keep_time"]); ?></td>
                                    <td><?php echo ($models["combo"]); ?></td>
                                    <td>
                                        <a class='btn btn-small' href='/bmw/admin.php/Scheduling/update/id/<?php echo ($models["id"]); ?>'><i class="icon-share"></i></a>
                                    </td>		
