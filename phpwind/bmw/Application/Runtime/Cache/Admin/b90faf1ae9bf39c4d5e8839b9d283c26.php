                   ...
                   <span><i class="icon-table"></i>服务列表
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
							...
							<?php if(is_array($combo)): foreach($combo as $key=>$combos): ?><tbody>
                                <tr align='center'>
                                    <td><?php echo ($combos["brand"]); ?></td>
                                    <td><?php echo ($combos["combo"]); ?></td>
									<td>
										<a href="/bmw/admin.php/Service/addService">添加服务</a>
                                        <a href="/bmw/admin.php/Service/delService/id/<?php echo ($combos["id"]); ?>" onclick="return confirm('你确定要删除吗？')">删除服务</a>
									</td>
                                </tr>
