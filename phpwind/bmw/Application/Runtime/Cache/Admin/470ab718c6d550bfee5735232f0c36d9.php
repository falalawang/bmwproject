        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li><a href="#" class="nav"><i class="icon-folder-closed"></i> 信息管理</a>
						<ul class="list">
							<li><a href="/bmw/admin.php/Message/messageList">信息列表</a></li>
							
						</ul>
					</li>
                    <?php if(session('gid') == 1): ?><li><a href="#" class="nav"><i class="icon-folder-closed"></i> 品牌管理</a>
                        <ul class="list">
                    ...
                    <li><a href="#" class="nav"><i class="icon-list"></i> 评价管理</a>
                        <ul class="list">					
                            <li><a href="/bmw/admin.php/Evaluation/evaluationList"> 评价列表</a></li>
                            <li><a href="/bmw/admin.php/Evaluation/userEvaluation">回收站</a></li>	
                        </ul>
                    </li>
		...
		<div id='mws-container' class='clearfix'>
			<div class='container'>
                ...
                <script>
                 ...
                 var id = id;
                    $.get('/bmw/admin.php/Service/carList', {'p':id}, function(data){  //用get方法发送信息到UserAction中的user方法
                     $("#user").replaceWith("<tr id='user'>"+data+"</tr>"); //user一定要和tpl中的一致
                });
             }
                </script>                    
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                        ...
                        <form action='/bmw/admin.php/Service/carList' method='post'>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
                            ...
                            <tbody>
                                  <?php if(is_array($model)): foreach($model as $key=>$models): ?><tr id='user'>
                                    <td align='center' id='brand'><?php echo ($models["brands"]); ?></td>
                                    <td align='center' id='series'><?php echo ($models["series"]); ?></td>
                                    <td align='center' id='model'><?php echo ($models["model"]); ?></td>			
									<td align='center'>
										<a href="/bmw/admin.php/Service/delModel/id/<?php echo ($models["id"]); ?>" onclick="return confirm('你确定要删除吗？')">删除</a>
										<a href="/bmw/admin.php/Service/addBrand">添加</a></td>
                ...
                /*
                    ...
                    $.ajax({"url":"/bmw/admin.php/Service/ajax",
                    "type":"get",
