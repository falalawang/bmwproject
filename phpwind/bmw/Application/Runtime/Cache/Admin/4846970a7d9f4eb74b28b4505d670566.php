...
<!--                     <li>
	...
	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/bmw/admin.php/Config/doconfig" method="post">
                              <div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">网站标题</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="small" name="title" value="<?php echo ($configs['0']['title']); ?>">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">网站关键字</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="medium" name="keywords" value="<?php echo ($configs[0][keywords]); ?>">
                    				</div>
                    			</div>
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<textarea rows="" cols="" class="large" name="description" placeholder="<?php echo ($configs[0]['description']); ?>"></textarea>
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">网站版权号</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="medium" name="copyright" value="<?php echo ($configs[0]['copyright']); ?>">
                    				</div>
                    			</div>
                                   <input type="hidden" name="id" value="<?php echo ($configs[0]['id']); ?>">
                    		</div>
