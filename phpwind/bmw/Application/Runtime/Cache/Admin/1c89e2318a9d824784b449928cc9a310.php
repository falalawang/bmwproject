...
<!--                     <li>
	...
	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>信息管理&nbsp;-->&nbsp;信息列表</span>
                    </div>
					<div class="mws-panel-body no-padding">
                        <table class="mws-table">
                            ...
                            <tbody>
								<?php if(is_array($message)): foreach($message as $key=>$mes): ?><tr>
										<td><?php echo ($mes['id']); ?></td>
										<td><?php echo ($mes['title']); ?></td>
										<td><?php echo ($mes['message']); ?></td>
										<td style='text-align:center'><a class='btn btn-small' href='/bmw/admin.php/Message/update/id/<?php echo ($mes["id"]); ?>'><i class="icon-pencil"></i></a></td>
									</tr><?php endforeach; endif; ?>
								<?php if(($pag < 2)): else: ?>
								<tr>
									<td style='background:#35353a;text-align:center' colspan='4'><?php echo ($show); ?></td>
								</tr><?php endif; ?>
                            </tbody>
                        </table>
                    </div>
