	...
	<!-- Main Container Start -->
            	...
            	<div id="rely" class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/bmw/admin.php/Wechat/insert" method="post">
                ...
                <div class="mws-panel grid_8" style="display:none">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<?php if(is_array($wechats)): foreach($wechats as $key=>$wechat): ?><form action="/bmw/admin.php/Wechat/mod" method="post">
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-stat-value">关键词：</label>
                    				<div class="mws-form-item">
                    					<input type="text" name="keyword" value="<?php echo ($wechat["keyword"]); ?>" class="small">
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<textarea rows="5" cols="100" style="resize:none" class="large" name="content"><?php echo ($wechat["content"]); ?></textarea>
                    				</div>
                    			</div>
                    		</div>
                    		<div class="mws-button-row" style="text-align:center">
