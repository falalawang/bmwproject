...
<!--                     <li>
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/bmw/admin.php/Service/addModels" method="post">
                 <div class="mws-form-inline">
                    <div class="mws-form-row">
                      <label class="mws-form-label">请添加品牌</label>
                        <div class="mws-form-item">
                            ...
                            <?php if(is_array($brands)): foreach($brands as $key=>$brands): ?><option value='<?php echo ($brands["id"]); ?>'><?php echo ($brands["brands"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="mws-form-row">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input type="text" name='models' class="large">
                        </div>
                    </div>
                </div>
