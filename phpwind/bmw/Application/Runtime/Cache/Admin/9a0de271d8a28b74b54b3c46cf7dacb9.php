	...
	<!-- Main Container Start -->
            	...
            	<div id="rely" class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span style="float:left">自动回复设置 </span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/bmw/admin.php/Wechat/dorely" method="post">
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">收件人：</label>
                    				<div class="mws-form-item">
                    					<input type="text" name="usernum" value="<?php echo ($usernum); ?>" class="small" readonly>
                    				</div>
                    			</div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">原消息：</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="message" value="<?php echo ($uwechat[0]['content']); ?>" class="small" readonly>
