	...
	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody id="t3">
                                <?php if(is_array($uwechats)): foreach($uwechats as $key=>$uwechat): ?><tr>
                                        <td id="t1"><?php echo ($uwechat['usernum']); ?></td>
                                        <td id="t2"><?php echo ($uwechat['content']); ?></td>
                                        <td id="t2"><?php echo (date("Y-m-d H:i:s",$uwechat['time'])); ?></td>

                                        <td style="text-align:center"> <a class="btn btn-small" href="/bmw/admin.php/Wechat/crely/id/<?php echo ($uwechat['id']); ?>">回复</a></td>
        ...
        $("#but").click(function(){
            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    $("#t3").replaceWith("<tbody><tr><td>"+msg.username+"</td><td>"+msg.phone+"</td><td style='text-align:center'><a  href='/bmw/admin.php/Wechat/mod/id/"+msg.id+"'><button><i class='icol-pencil'></i></button></a>|<a href='/bmw/admin.php/Wechat/del/id/"+msg.id+"'><button><i class='icol-cross'></i></button></a>|<a href='/bmw/admin.php/Wechat/auth/id/"+msg.id+"'><button><i style='color:red'>修改权限</i></button></a></td></tr><tr><td colspan='5' style='background:#35353a;text-align:center'><a href='/bmw/admin.php/Wechat/userList'><button>返回首页</button></a></td></tr></tbody>");
                }
