            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
							...
							<?php if(is_array($message)): foreach($message as $key=>$messages): ?><froeach >
                            <tbody>
                                <tr align='center'>
                                    <td><?php echo ($messages["username"]); ?></td> 
                                    <td><?php echo ($messages["combo"]); ?></td>
                                    <td><?php echo ($messages["message"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$messages["ctime"])); ?></td>
                                    <td>
                                        <a href="#">删除</a>
                                        <a href="#">修改</a>
                                    </td>
