			...
			<div class='container'>
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/bmw/admin.php/Service/insert" method="post" enctype="multipart/form-data" id="myform">
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">品牌</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="small" name='brands' id='brand'><span id="sty"></span>
                    				</div>
                    			</div>
                       		</div>
                ...
                <script>
                        $("#brand").blur(function(){
                            $.get("/bmw/admin.php/Service/aa",{"brand":$("#brand").val()},
                               function(data){
                                    $a=eval(data);
