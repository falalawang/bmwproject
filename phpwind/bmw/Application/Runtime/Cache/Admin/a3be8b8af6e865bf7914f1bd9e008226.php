...
<!--                     <li>
	...
	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/bmw/admin.php/Config/dologo" method="post" enctype="multipart/form-data">
                              <div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">当前LOGO</label>
			                			...
			                			<li>
			                            	<span class="thumbnail"><img src="/bmw/Public<?php echo ($logos[0]["logo"]); ?>" alt=""></span>
			                            </li>
                    			...
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">更换LOGO</label>
                    				<div class="mws-form-item">
