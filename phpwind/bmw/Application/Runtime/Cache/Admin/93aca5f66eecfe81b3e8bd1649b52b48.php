		...
		<div id='mws-container' class='clearfix'>
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <?php if(is_array($images)): foreach($images as $key=>$image): ?><form class="mws-form" action="/bmw/admin.php/Wechat/update" method="post">
                    		<div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">关键字：</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="mws-form-item-1-8" class="small" name="keyword" value="<?php echo ($image["keyword"]); ?>" required>
                                    </div>
                                </div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">图文主题：</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="small" name="title" value="<?php echo ($image["title"]); ?>" required>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="imageurl" value="<?php echo ($image["imageurl"]); ?>" required>
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">网站地址：</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="small" name="url" value="<?php echo ($image["url"]); ?>" required>
                                    </div>
                                </div>
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<textarea rows="" cols="" class="large" name="dscription" required><?php echo ($image["description"]); ?></textarea>
                    				</div>
                    			</div>
                    		...
                    		<div class="mws-button-row">
                    			...
                    			<a  class="btn " href = '/bmw/admin.php/Wechat/del/id/<?php echo ($image["id"]); ?>'>删除</a>
                    		</div>
