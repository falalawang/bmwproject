...
<link rel="stylesheet" type="text/css" href="/bmw/Public/Admin/css/login.css" media="screen">
...
<body>
    ...
    <div id="mws-login-wrapper">
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="/bmw/admin.php/Login/dologin" method="post">
    ...
    <script src="/bmw/Public/Admin/jui/js/jquery-ui-effects.min.js"></script>

    <!-- Plugin Scripts -->
    <script src="/bmw/Public/Admin/plugins/validate/jquery.validate-min.js"></script>

    <!-- Login Script -->
    <script src="/bmw/Public/Admin/js/core/login.js"></script>
