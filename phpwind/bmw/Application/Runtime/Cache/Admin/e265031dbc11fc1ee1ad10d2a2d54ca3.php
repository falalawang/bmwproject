...
<!--                     <li>
	...
	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/bmw/admin.php/LinksList/update" method="post">
                              <div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">友链名称</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="medium" name="links_id" value="<?php echo ($links[0]["links_id"]); ?>">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">友情链接</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="medium" name="links" value="<?php echo ($links[0]["links"]); ?>">
                    				</div>
                    			</div>
