...
<div class="mws-panel grid_8">
                	<div class="mws-panel-header" style='text-align:right'>
                        ...
                        <form action='/bmw/admin.php/Order/orderList' method='post'>
                        ...
                        <table class="mws-table">
                            ...
                            <tbody>
								<?php if(is_array($orders)): foreach($orders as $key=>$order): ?><tr>
										...
										<td><?php echo ($order['keep_time']); ?></td>
										<td><?php echo ($order['price']); ?></td>
										<td><?php echo ($order['LPN']); ?></td>
										<td><?php echo ($order['sid']); ?></td>
										<td><?php echo ($order['status']); ?></td>
										<td><?php echo ($order['star']); ?></td>
										<td><a class='btn btn-small' href='/bmw/admin.php/Order/updatea/id/<?php echo ($order["id"]); ?>'><i class="icon-pencil"></i></a><a class='btn btn-small' href='/bmw/admin.php/Order/deletea/id/<?php echo ($order["id"]); ?>'><i class="icon-share"></i></a></td>
									</tr><?php endforeach; endif; ?>
								<?php if(($pag < 2)): else: ?>
								<tr>
									<td style='background:#35353a;text-align:center' colspan='9'><?php echo ($show); ?></td>
								</tr><?php endif; ?>
                            </tbody>
                        </table>
                    </div>
