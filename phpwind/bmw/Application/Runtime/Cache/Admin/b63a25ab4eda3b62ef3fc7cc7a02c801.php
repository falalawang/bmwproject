            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span style="float:left">修改关注回复</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/bmw/admin.php/Wechat/modcontent" method="post">
                    		<div class="mws-form-inline">

                    			<div class="mws-form-row">
                    				<label class="mws-form-label">关注回复内容：</label>
                    				<div class="mws-form-item">
                    					<textarea rows="" cols="" class="large" name="content" required><?php echo ($subs); ?></textarea>
                    				</div>
