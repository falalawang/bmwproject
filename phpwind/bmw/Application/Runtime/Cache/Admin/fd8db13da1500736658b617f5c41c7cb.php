                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody id="t3">
                                <?php if(is_array($admins)): foreach($admins as $key=>$admin): ?><tr>
                                        <td id="t1"><?php echo ($admin['username']); ?></td>
                                        <td id="t2"><?php echo ($admin['phone']); ?></td>
                                        <td style="text-align:center"><a class="btn btn-small" href="/bmw/admin.php/User/mod/id/<?php echo ($admin['id']); ?>"><i class="icon-pencil"></i></a> | <a class="btn btn-small" href="/bmw/admin.php/User/del/id/<?php echo ($admin['id']); ?>"><i class="icon-trash"></i></a> | <a class="btn btn-small" href="/bmw/admin.php/User/auth/id/<?php echo ($admin['id']); ?>">修改权限</a></td>
                                    </tr><?php endforeach; endif; ?>

								<tr><td colspan="5" style="background:#35353a;text-align:center"><?php echo ($show); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        $("#but").click(function(){
            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    $("#t3").replaceWith("<tbody><tr><td>"+msg.username+"</td><td>"+msg.phone+"</td><td style='text-align:center'><a  href='/bmw/admin.php/User/mod/id/"+msg.id+"'><button><i class='icol-pencil'></i></button></a>|<a href='/bmw/admin.php/User/del/id/"+msg.id+"'><button><i class='icol-cross'></i></button></a>|<a href='/bmw/admin.php/User/auth/id/"+msg.id+"'><button><i style='color:red'>修改权限</i></button></a></td></tr><tr><td colspan='5' style='background:#35353a;text-align:center'><a href='/bmw/admin.php/User/userList'><button>返回首页</button></a></td></tr></tbody>");
                }
