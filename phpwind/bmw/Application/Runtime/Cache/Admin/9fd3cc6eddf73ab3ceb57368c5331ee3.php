...
<div class="mws-panel grid_8">
                	<div class="mws-panel-header" style='text-align:right'>
                        ...
                        <form action='/bmw/admin.php/Log/delete' method='post'>
                        ...
                        <table class="mws-table">
                            ...
                            <tbody>
								<?php if(is_array($logs)): foreach($logs as $key=>$log): ?><tr>
										...
										<td style='text-align:center'><a class='btn btn-small' href='/bmw/admin.php/Log/delete/id/<?php echo ($log["id"]); ?>'><i class="icon-trash"></i></a></td>
