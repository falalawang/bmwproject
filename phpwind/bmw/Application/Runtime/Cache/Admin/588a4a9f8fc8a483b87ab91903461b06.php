			...
			<div class='container'>
                ...
                <script src="/bmw/Public/Admin/js/core/ajax.js"></script>     
                	...
                	<div class="mws-panel-header">
                        ...
                        <select name='brand' id='brand'>
                                <option>请选择品牌</option>
                                 <?php if(is_array($brand)): foreach($brand as $key=>$brands): ?><option value='<?php echo ($brands["id"]); ?>'><?php echo ($brands["brand"]); ?></option><?php endforeach; endif; ?>
                        </select>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <select id='series'>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
							...
							<?php if(is_array($price)): foreach($price as $key=>$prices): ?><tbody>
                                <tr align='center'>
                                    <td><?php echo ($prices["brand"]); ?></td>
                                    <td><?php echo ($prices["series"]); ?></td>
                                    <td><?php echo ($prices["models"]); ?></td>		
                                    <td><?php echo ($prices["project"]); ?></td>		
                                    <td><?php echo ($prices["low_price"]); ?></td>	
                                    <td><?php echo ($prices["high_price"]); ?></td>
                                    <td>
										<a href='/bmw/admin.php/Service/updatePrice/id/<?php echo ($prices["id"]); ?>'>修改价格</a>
									</td>
                                </tr><?php endforeach; endif; ?>
                            <tr>
                                <td style='background:#35353a;text-align:center' colspan='16'><?php echo ($show); ?></td>
                            </tr>
                             </tbody>
                        </table>
                    </div>
                ...
                <script>
                    $("#brand").change(function(){
                        //alert($("#brand").val());
                        $.ajax({"url":"/bmw/admin.php/Service/ajaxPrice",
                                "type":"post",
                ...
                $("#series").change(function(){
                    //alert($("series").val());
                    $.ajax({"url":"/bmw/admin.php/Service/ajaxAction",
                                "type":"post",
