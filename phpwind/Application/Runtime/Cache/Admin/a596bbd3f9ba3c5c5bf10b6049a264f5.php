            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        车系列表&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin.php/Models/addSeries"><button class="btn btn-primary pull-right" title="添加车系" alt="添加车系"><i class="fa fa-plus">&nbsp;添加</i></button></a>
                    </header>
                    <div class="panel-body">
                        <div class="adv-table">
                            <table  class="display table table-bordered table-striped" id="dynamic-table">
                                ...
                                <tbody>
                                    <?php if(is_array($series)): foreach($series as $key=>$serie): ?><tr class="gradeX">
                                            <td class="hidden-sm"><?php echo ($serie['count']); ?></td>
                                            <td><?php echo ($serie['series']); ?></td>
                                            <?php if($_SESSION['auth']!= '2'): ?><td class="center hidden-sm"><a href="/admin.php/Models/modSeries/id/<?php echo ($serie['id']); ?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin.php/Models/delSeries/id/<?php echo ($serie['id']); ?>" onclick=" return confirm('你确定要删除此车系及车型么？')">删除</a></td><?php endif; ?>
