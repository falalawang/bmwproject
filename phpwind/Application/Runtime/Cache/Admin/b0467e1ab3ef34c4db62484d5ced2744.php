            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        服务车列表
                        <a href="/admin.php/ServerCar/addServerCar"><button class="btn btn-primary pull-right"><i class="fa fa-plus">&nbsp;添加</i></button></a>
                    </header>
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            ...
                            <tr>
                    	        ...
                    	        <tbody>
                    				<?php if(is_array($serverCar)): foreach($serverCar as $key=>$data): ?><tr class="gradeX">
                                            <td><?php echo ($data['id']); ?></td>
                    			            <td><?php echo ($data['mark']); ?></td>
                    			            <td><a href="/admin.php/ServerCar/modServerCar/id/<?php echo ($data['id']); ?>">修改</a>&nbsp;&nbsp;<a href="/admin.php/ServerCar/delServerCar/id/<?php echo ($data['id']); ?>" onclick="return confirm('你确定要删除吗？')">删除</a></td>
