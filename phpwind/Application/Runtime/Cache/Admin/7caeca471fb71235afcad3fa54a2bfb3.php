        ...
        <div class="col-sm-12">
            <section class="panel">
                <header class="panel-heading">
                    套餐列表
                    <?php if($_SESSION['auth']!= '2'): ?><a href="/admin.php/Combo/addCombo"><button class="btn btn-primary pull-right"><i class="fa fa-plus">&nbsp;添加</i></button></a><?php endif; ?>
                </header>
                <div class="panel-body">
                    <div class="adv-table">
                        <table  class="display table table-bordered table-striped" id="dynamic-table">
                                <tr>
                                    <th>编号</th>
                                    <th>套餐</th>
                                    <?php if($_SESSION['auth']!= '2'): ?><th class="hidden-sm">操作</th><?php endif; ?>
                                </tr>
                            <tbody>
                               <?php if(is_array($combo)): foreach($combo as $key=>$datas): ?><tr class="gradeX">
                                        <td class="hidden-sm"><?php echo ($datas['id']); ?></td>
                                        <td class="hidden-sm"><?php echo ($datas['name']); ?></td>
                                   
                                        <?php if($datas['highPrice'] == ''): else: ?>- <?php echo ($datas['highPrice']); endif; ?></td>
                                         <?php if($_SESSION['auth']!= '2'): ?><td class="hidden-sm"><a href="/admin.php/Combo/modCombo/id/<?php echo ($datas['id']); ?>">修改&nbsp;&nbsp;<a href="/admin.php/Combo/delCombo/name/<?php echo ($datas['name']); ?>" onclick="return confirm('你确定要删除此套餐吗？')">删除</td><?php endif; ?>
