...
<div class="wrapper">
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="/admin.php/Manage/insert" id="myform" class="form-horizontal adminex-form" method="post">
                    <div class="form-group">
                        ...
                        <span class="col-sm-4 control-msg" id="nameMsg"></span>
					...
					<div class="form-group">
                        ...
                        <span class="col-sm-4 control-msg" id="pwdMsg1"></span>
                    </div>
					<div class="form-group">
                        <div class="col-sm-2"></div>
                        ...
                        <span class="col-sm-4 control-msg" id="pwdMsg2"></span>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2"></div>
                        ...
                        <span class="col-sm-4 control-msg" id="telMsg"></span>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-2"></div>
                        <label class="col-sm-2 control-label col-sm-2">权限</label>
                        <div class="col-sm-4">
        ...
        <script type="text/javascript">
            ...
            function checkUserName(){
                if($('#name').val() == ''){
                    ...
                    $.ajax({
                        type: "get",
                        url: "/admin.php/Manage/checkName",
                        data: "name="+$('#name').val(),
                        success: function(d){
                            if(d == '1'){
