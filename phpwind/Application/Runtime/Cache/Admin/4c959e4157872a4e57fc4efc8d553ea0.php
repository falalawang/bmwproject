...
<div class="wrapper">
	<div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="/admin.php/Manage/updateSwitch" class="form-horizontal adminex-form" method="post">
                	<input type="hidden" name="id" value="<?php echo ($sw[0]['id']); ?>" />
                    <div style="margin-bottom:30px; padding:10px;">
                    	<?php if($sw[0]['webStatus'] == '1'): ?><div class="col-sm-4"></div>
                        ...
                        <?php else: ?>
                        	...
                        	<div class="col-sm-2"><input type="radio" name="webStatus" value="0" checked />关</div><?php endif; ?>
                    </div>
