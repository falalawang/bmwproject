...
<div class="wrapper">
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="/admin.php/ServerCar/insert" class="form-horizontal adminex-form" method="post" id="myform">
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label"> 服务车编号</label>
                        <div class="col-sm-6">
                            <select name="carId" id="mark" class="form-control col-sm-6">
                            <?php if(is_array($serverCar)): foreach($serverCar as $key=>$mark): ?><option value="<?php echo ($mark['id']); ?>"><?php echo ($mark['mark']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">    
                        <?php if(is_array($allServiceman)): foreach($allServiceman as $key=>$all): ?><div class="col-sm-4">
                                <?php if(in_array(($all["id"]), is_array($serviceman)?$serviceman:explode(',',$serviceman))): ?><input id="name" type="checkbox" name="servicemanId[]" value="<?php echo ($all['id']); ?>" checked disabled /><?php echo ($all['name']); ?>
                                <?php else: ?>
                                    <input id="name" type="checkbox" name="servicemanId[]" value="<?php echo ($all['id']); ?>" /><?php echo ($all['name']); endif; ?>        
