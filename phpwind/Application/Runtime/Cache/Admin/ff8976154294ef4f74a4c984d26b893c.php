...
<div class="wrapper">
    <div class="row">
        ...
        <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
            <?php if(is_array($manager)): foreach($manager as $key=>$manager): ?><tr class="gradeX">
                    <td><?php echo ($manager['id']); ?></td>
                    <td><?php echo ($manager['name']); ?></td>
                    <td>
                        <?php if($manager['auth'] == '0'): ?>超级管理员
                            <?php elseif($manager['auth'] == '1'): ?>管理员
                            <?php elseif($manager['auth'] == '2'): ?>客服<?php endif; ?>
                    </td>
                    <td class="hidden-sm"><?php echo ($manager['telephone']); ?></td>
                    <td><a href="/admin.php/Manage/mod/id/<?php echo ($manager['id']); ?>">修改密码</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php if($_SESSION['auth']== '0'): ?><a href="/admin.php/Manage/auth/id/<?php echo ($manager['id']); ?>">权限</a>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?><a href="/admin.php/Manage/able/id/<?php echo ($manager['id']); ?>">
                    <?php if($manager['status'] == '0'): ?>禁用
