    ...
    <div class="row">
        ...
        <section class="panel">
            <header class="panel-heading">
                <a href="/admin.php/Models/typesList">车型列表</a>&nbsp;>>&nbsp;修改车型
            </header>
            <div class="panel-body">
                <form action="/admin.php/Models/updateType" class="form-horizontal adminex-form" id="myform" method="post">
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">品牌</label>
                        <div class="col-sm-4">
                            <input type="text" id="brand" class="form-control" name="brand" value="<?php echo ($model[0]['brand']); ?>" disabled />
                        </div>
                    </div>
                    <div class="col-sm-2"></div>
					<div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="series" class="form-control" name="series" value="<?php echo ($model[0]['series']); ?>" disabled>
                        </div>
                    </div>
                    <div class="col-sm-2"></div>
					<div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" id="types" class="form-control" name="types" value="<?php echo ($model[0]['types']); ?>" />
                        </div>
