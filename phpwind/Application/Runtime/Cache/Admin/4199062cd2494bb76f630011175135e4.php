        	...
        	<div class="col-sm-12">
        		<section class="panel">
			        <header class="panel-heading">
			            品牌列表&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin.php/Models/addBrand"><button class="btn btn-primary pull-right" title="添加品牌" alt="添加品牌"><i class="fa fa-plus">&nbsp;添加</i></button></a>
			        </header>
        			<div class="panel-body">
        				<div class="adv-table">
        					<table  class="display table table-bordered table-striped" id="dynamic-table">
        						...
        						<tbody>
									<?php if(is_array($brands)): foreach($brands as $key=>$brand): ?><tr class="gradeX">
								            <td class="hidden-sm"><?php echo ($brand['count']); ?></td>
								            <td><?php echo ($brand['brand']); ?></td>
								            <?php if($_SESSION['auth']!= '2'): ?><td class="center hidden-sm"><a href="/admin.php/Models/modBrand/id/<?php echo ($brand['id']); ?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin.php/Models/delBrand/id/<?php echo ($brand['id']); ?>" onclick=" return confirm('你确定要删除此品牌及该品牌下的所有车型么？')">删除</a></td><?php endif; ?>
