                ...
                <div class="panel-body">
                    <div class="adv-table">
                        <table  class="display table table-bordered table-striped" id="dynamic-table">
                            ...
                            <tbody>
                               <?php if(is_array($datas)): foreach($datas as $key=>$datas): ?><tr class="gradeX">
                                        <td><?php echo ($datas['id']); ?></td>
                                        <td class="hidden-sm"><?php echo ($datas['brand']); ?></td>
                                        <td><?php echo ($datas['series']); ?></td>
                                        <td><?php echo ($datas['types']); ?></td>
                                        <td><?php echo ($datas['comboName']); ?></td>
                                        <td>
                                            <?php if($datas['highPrice'] == '0' or $datas['highPrice'] == ''): echo ($datas['lowPrice']); ?>元
                                            <?php else: ?>
                                                <?php echo ($datas['lowPrice']); ?>-<?php echo ($datas['highPrice']); ?>元<?php endif; ?>
                                        </td>
                                         <?php if($_SESSION['auth']!= '2'): ?><td class="hidden-sm"><a href="/admin.php/Combo/modPrice/id/<?php echo ($datas['id']); ?>">修改</td><?php endif; ?>
