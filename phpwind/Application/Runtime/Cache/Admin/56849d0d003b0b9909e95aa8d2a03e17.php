    ...
    <div class="row">
        ...
        <section class="panel">
            <header class="panel-heading">
                <a href="/admin.php/Models/seriesList">车系列表</a>&nbsp;>>&nbsp;修改车系
            </header>
            <div class="panel-body">
                <form action="/admin.php/Models/updateSeries" class="form-horizontal adminex-form" id="myform" method="post">
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">品牌</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="brand" value="<?php echo ($series[0]['brand']); ?>" disabled />
                        </div>
                    </div>
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">车系</label>
                        <input type="hidden" name="id" value="<?php echo ($series[0]['id']); ?>" />
                        <div class="col-sm-4">
                            <input type="text" id="series" class="form-control" name="series" value="<?php echo ($series[0]['series']); ?>" />
                        </div>
                        <span class="col-sm-2 control-msg" id="sMsg"></span>
                    </div>
