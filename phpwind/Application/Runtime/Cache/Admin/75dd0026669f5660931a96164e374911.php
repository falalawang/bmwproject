    ...
    <div class="row">
        ...
        <section class="panel">
            <header class="panel-heading">
                <a href="/admin.php/Models/seriesList">车系列表</a>&nbsp;>>&nbsp;添加车系
            </header>
            <div class="panel-body">
                <form action="/admin.php/Models/insertSeries" class="form-horizontal adminex-form" id="myform" method="post" name="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select name="brandId" id="brand" class="form-control m-bot15">
                                ...
                                <?php if(is_array($brands)): foreach($brands as $key=>$brand): ?><option value="<?php echo ($brand['id']); ?>"><?php echo ($brand['brand']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-2"></div>
...
<script>
    ...
    function checkSeries(){
        if($('#series').val() == ''){
            ...
            var data = {sName:$('#series').val()};
            $.get('seriesCheck',data,function(d){
                if(d == 2){
                    $('#sMsg').html('车系已存在').css('color','red');
                    sName = false;
                }else{
