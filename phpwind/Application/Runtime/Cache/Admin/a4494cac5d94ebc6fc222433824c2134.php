            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        4S店列表
                        <a href="/admin.php/ServerCar/addStore"><button class="btn btn-primary pull-right"><i class="fa fa-plus">&nbsp;添加</i></button></a>
                    </header>
                    <div class="panel-body">
                        <div class="adv-table">
                            ...
                            <tr>
                                ...
                                <th class="col-sm-9">4S店名称</th>
                                <th class="col-sm-">操作</th>
                            </tr>
                    	        <tbody>
                    				<?php if(is_array($store)): foreach($store as $key=>$store): ?><tr class="gradeX">
                                            <td><?php echo ($store['id']); ?></td>
                    			            <td><?php echo ($store['storeName']); ?></td>
                    			            <td><a href="/admin.php/ServerCar/modStore/id/<?php echo ($store['id']); ?>">修改</a>&nbsp;&nbsp;<a href="/admin.php/ServerCar/delStore/id/<?php echo ($store['id']); ?>" onclick="return confirm('你确定要删除吗？')">删除</a></td>
