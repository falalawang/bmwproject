...
<div class="wrapper">
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="/admin.php/Order/updateOrder" class="form-horizontal adminex-form" method="post">
                    <input type="hidden" name="id" value="<?php echo ($order[0]['id']); ?>" />
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">联&nbsp;&nbsp;系&nbsp;&nbsp;人</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="user" value="<?php echo ($order[0]['user']); ?>" />
                        </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="telephone" value="<?php echo ($order[0]['telephone']); ?>" />
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    <div class="col-sm-2"></div>
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="address" value="<?php echo ($order[0]['address']); ?>" />
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="carType" value="<?php echo ($order[0]['carType']); ?>" readonly />
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <!--遍历出所有套餐-->
                            <?php if(is_array($combos)): foreach($combos as $key=>$combo): ?><div class="col-lg-6" style="margin-bottom:10px;">
                                    <!--in判断一个变量是否在数组中（前面name中的值为变量,value值为数组或逗号分隔的字符串）-->
                                    <?php if(in_array(($combo['comboName']), is_array($order[0]['combo'])?$order[0]['combo']:explode(',',$order[0]['combo']))): if($combo['highPrice']): ?><input type="checkbox" name="combo[]" value="<?php echo ($combo['comboName']); ?>" checked>&nbsp;&nbsp;<?php echo ($combo['comboName']); ?>&nbsp;<?php echo ($combo['lowPrice']); ?>-<?php echo ($combo['highPrice']); ?>元
                                        <?php else: ?>
                                            <input type="checkbox" name="combo[]" value="<?php echo ($combo['comboName']); ?>" checked>&nbsp;&nbsp;<?php echo ($combo['comboName']); ?>&nbsp;<?php echo ($combo['lowPrice']); ?>元<?php endif; ?>
                                    <?php else: ?>
                                        <?php if($combo['highPrice']): ?><input type="checkbox" name="combo[]" value="<?php echo ($combo['comboName']); ?>" />&nbsp;&nbsp;<?php echo ($combo['comboName']); ?>&nbsp;<?php echo ($combo['lowPrice']); ?>-<?php echo ($combo['highPrice']); ?>元
                                        <?php else: ?>
                                            <input type="checkbox" name="combo[]" value="<?php echo ($combo['comboName']); ?>" />&nbsp;&nbsp;<?php echo ($combo['comboName']); ?>&nbsp;<?php echo ($combo['lowPrice']); ?>元<?php endif; endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2 col-lg-2">
                            <input type="text" class="form-control" name="orderDate" value="<?php echo ($order[0]['orderDate']); ?>" />
                        </div>
                        <div class="col-sm-2 col-lg-2">
                            <select class="form-control m-bot15" name="orderTime">
                                <?php if($order[0]['orderTime'] == '08:00-10:00'): ?><option value="08:00-10:00" selected>08:00-10:00</option>
                                    <option value="10:00-12:00">10:00-12:00</option>
                                    <option value="14:00-16:00">14:00-16:00</option>
                                    <option value="16:00-18:00">16:00-18:00</option>
                                <?php elseif($order[0]['orderTime'] == '10:00-12:00'): ?>
                                    <option value="08:00-10:00">08:00-10:00</option>
                                    <option value="10:00-12:00" selected>10:00-12:00</option>
                                    <option value="14:00-16:00">14:00-16:00</option>
                                    <option value="16:00-18:00">16:00-18:00</option>
                                <?php elseif($order[0]['orderTime'] == '14:00-16:00'): ?>
                                    <option value="08:00-10:00">08:00-10:00</option>
                                    <option value="10:00-12:00">10:00-12:00</option>
                                    <option value="14:00-16:00" selected>14:00-16:00</option>
                                    <option value="16:00-18:00">16:00-18:00</option>
                                <?php elseif($order[0]['orderTime'] == '16:00-18:00'): ?>
                                    <option value="08:00-10:00">08:00-10:00</option>
                                    <option value="10:00-12:00">10:00-12:00</option>
                                    <option value="14:00-16:00">14:00-16:00</option>
                                    <option value="16:00-18:00" selected>16:00-18:00</option><?php endif; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-5"></div>
...
<script language="javascript" type="text/javascript" src="/Public/admin/date/WdatePicker.js"></script>
