                    ...
                    <div class="row state-overview">
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel purple">
                                ...
                                <div class="state-value"><a style="color:white" href="/admin.php/Order/index">
                                    <div class="value">未审核订单</div>
                                    <div class="title"><?php echo ($order); ?></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel red">
                                ...
                                <div class="state-value"><a style="color:white" href="/admin.php/Order/index">
                                    ...
                                    <div class="title"><?php echo ($orders); ?></a></div>
                                </div>
                            </div>
                        </div>
                    </div><br /><br />
                    <div class="row state-overview">
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel blue">
                                ...
                                <div class="state-value"><a style="color:white" href="/admin.php/Customer/wechat">
                                    <div class="value">微信关注</div>
                                    <div class="title"><?php echo ($users); ?></a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xs-12 col-sm-6">
                            <div class="panel green">
                                ...
                                <div class="state-value"><a style="color:white" href="/admin.php/Order/index">
                                    <div class="value"> 订单评价</div>
                                    <div class="title"><?php echo ($evas); ?></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
