            ...
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading">
                        自动回复列表
                        <a href="/admin.php/AutoReply/add"><button class="btn btn-primary pull-right" title="添加品牌" alt="添加品牌"><i class="fa fa-plus">&nbsp;添加</i></button></a>
                    </header>
                    <div class="panel-body">
                        <div class="adv-table">
                            ...
                            <tr>
                    	        ...
                    	        <tbody>
                    				<?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="gradeX">
                                            <td><?php echo ($list['id']); ?></td>
                    			            <td><?php echo ($list['keyword']); ?></td>
                                            <td class="hidden-sm"><div style="width:480px;height:18px;text-overflow:ellipsis;overflow:hidden;white-space:nowrap"><?php echo ($list['content']); ?></div>
                                            </td>  
                    			            <td><a href="/admin.php/AutoReply/mod/id/<?php echo ($list['id']); ?>">修改</a>&nbsp;&nbsp;<a href="/admin.php/AutoReply/del/id/<?php echo ($list['id']); ?>" onclick="return confirm('你确定要删除吗？')">删除</a></td>
