                        ...
                        <table  class="display table table-bordered table-striped" id="dynamic-table">
                            ...
                            <tbody>
                                <?php if(is_array($orders)): foreach($orders as $key=>$order): ?><tr class="gradeX">
                                        <td width="6%"><?php echo ($order['count']); ?></td>
                                        <td width="5%">
                                        ...
                                        <td width="6%"><?php echo ($order['lastPrice']); ?></td>
                                        <td width="5%">
                                            <?php echo (date("Y-m-d",$order['orderDate'])); ?>&nbsp;<?php echo ($order['orderTime']); ?>
                                        </td>
                                        <td width="6%"><?php echo ($order['carNumber']); ?></td>
                                        <td width="6%"><?php echo ($order['vin']); ?></td>
                                        <td width="5%">
                                            <font color='red'>已取消</font>
                                        </td>
                                        <td width="7%">
                                            <a href="/admin.php/Order/del/id/<?php echo ($order['id']); ?>" title="删除" alt="删除"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="9">
                                            ...
                                            <?php if(is_array($order["combo"])): foreach($order["combo"] as $k=>$c): ?><span style="float:left;"><?php echo ($c); ?>:<?php echo ($order['price'][$k]); ?>元;&nbsp;</span><?php endforeach; endif; ?>
                                        </td>
