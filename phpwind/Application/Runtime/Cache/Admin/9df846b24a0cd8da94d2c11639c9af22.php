...
<script src="/Public/admin/js/jquery.js"></script>
	<div class="wrapper">
        ...
        <header class="panel-heading">
            车型列表
            <?php if($_SESSION['auth']!= '2'): ?><a href="/admin.php/Models/addTypes"><button class="btn btn-primary pull-right" title="添加车型" alt="添加车型"><i class="fa fa-plus">&nbsp;添加</i></button></a><?php endif; ?>
        </header>
        <div class="panel-body">
        <div class="adv-table">
        ...
        <tbody>
		<?php if(is_array($models)): foreach($models as $key=>$model): ?><tr class="gradeX">
            <td class="hidden-sm"><?php echo ($model['count']); ?></td>
            <td><?php echo ($model['brand']); ?></td>
            <td><?php echo ($model['series']); ?></td>
            <td><?php echo ($model['types']); ?></td>
            <?php if($_SESSION['auth']!= '2'): ?><td class="center hidden-sm"><a href="/admin.php/Models/modTypes/id/<?php echo ($model['id']); ?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin.php/Models/delType/id/<?php echo ($model['id']); ?>" onclick="return confirm('你确定要删除该车型吗？')">删除</a></td><?php endif; ?>
