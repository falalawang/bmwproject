                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            ...
                            <tr>
                    	        ...
                    	        <tbody>
                    				<?php if(is_array($data)): foreach($data as $key=>$data): ?><tr class="gradeX">
                    			            <td><?php echo ($data['storeName']); ?></td>
                                            <td><?php echo ($data['mark']); ?></td>
                                            <td>
                                            <?php if(is_array($data['servicemanId'])): foreach($data['servicemanId'] as $key=>$rid): if(is_array($serviceman)): foreach($serviceman as $key=>$arr): if($arr['id'] == $rid): echo ($arr['name']); ?>&nbsp;&nbsp;<?php endif; endforeach; endif; endforeach; endif; ?>
