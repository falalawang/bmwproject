...
<div class="wrapper">
    <div class="row">
        ...
        <header class="panel-heading">
            技师列表
            <a href="/admin.php/ServerCar/addServiceman"><button class="btn btn-primary pull-right"><i class="fa fa-plus">&nbsp;添加</i></button></a>&nbsp;&nbsp;
            <a href="/admin.php/ServerCar/selectServiceman">&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-primary pull-right"><i class="fa fa-edit">&nbsp;分配</i></button></a>
        </header>
        <div class="panel-body">
        <div class="adv-table">
        <table  class="display table table-bordered table-striped" id="dynamic-table">
            ...
            <tbody>
            <?php if(is_array($serviceman)): foreach($serviceman as $key=>$data): ?><tr class="gradeX">
                    <td><?php echo ($data['id']); ?></td>
                    <td><?php echo ($data['name']); ?></td>
                    <td class="hidden-sm"><?php echo ($data['telephone']); ?></td>
                    <td><a href="/admin.php/ServerCar/mod/id/<?php echo ($data['id']); ?>">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="/admin.php/ServerCar/able/id/<?php echo ($data['id']); ?>">
                    <?php if($data['status'] == '0'): ?>禁用
                    <?php else: ?>启用<?php endif; ?></a></td>
