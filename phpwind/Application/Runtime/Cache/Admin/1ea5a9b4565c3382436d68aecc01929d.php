...
<div class="wrapper">
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="/admin.php/Combo/insertPrice" class="form-horizontal adminex-form" method="post" id="myform">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control m-bot15" id="brand" name="brand">
		                        ...
		                        <?php if(is_array($brands)): foreach($brands as $key=>$brand): ?><option value="<?php echo ($brand['brand']); ?>"><?php echo ($brand['brand']); ?></option><?php endforeach; endif; ?>
	                    	</select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control m-bot15" id="combo" name="combo">
                               ...
                               <?php if(is_array($combos)): foreach($combos as $key=>$combos): ?><option value="<?php echo ($combos['id']); ?>" hidden><?php echo ($combos['name']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="col-sm-3">
                            <input type="text" class="form-control" name="lowPrice" id="lowPrice" value="" /></div>
                            <div class="col-sm-3">
                            <input type="text" class="form-control" name="highPrice" id="highPrice" value="" /></div>
                            <div class="col-sm-6">
...
<script>
    ...
    $('#brand').change(function(){
        if($('#brand').val() == '-1'){
            ...
            $.get('/admin.php/Combo/selectSerie',data,function(d){
               // alert(d);
                $('#series').html(d);
    ...
    $('#series').change(function(){
        if($('#series').val() == '-1'){
            ...
            $.get('/admin.php/Combo/selectType',data,function(d){
                $('#types').html(d);
            });
        }
    });
