    ...
    <div class="row">
        ...
        <section class="panel">
            <header class="panel-heading">
             <a href="/admin.php/Manage/mylist">后台人员列表</a>>>
                更改权限
            </header>
            <div class="panel-body">
                <form action="/admin.php/Manage/authMod/id/<?php echo ($manager[0]['id']); ?>" id="myform" class="form-horizontal adminex-form" method="post">
                    <div class="form-group">
                        <div class="col-sm-2"></div>
                        <label class="col-sm-2 col-sm-2 control-label">用户名</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="name" value="<?php echo ($manager[0]['name']); ?>" readonly/>
                        </div>
