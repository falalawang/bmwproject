    ...
    <div class="row">
        ...
        <section class="panel">
            <header class="panel-heading">
                <a href="/admin.php/Combo/comboList">套餐列表</a>>>增加套餐
            </header>
            <div class="panel-body">
                <form action="/admin.php/Combo/insertCombo" class="form-horizontal adminex-form" method="post">
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">套餐：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="name" id="combo" value="" />
                        </div>
