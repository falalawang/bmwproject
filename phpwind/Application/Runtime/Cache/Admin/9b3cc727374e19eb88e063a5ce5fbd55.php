...
<div class="wrapper">
    <div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form action="/admin.php/Manage/updateSet" class="form-horizontal adminex-form" method="post" enctype='multipart/form-data'>
                    <input type="hidden" name="id" value="<?php echo ($web[0]['id']); ?>" />
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">网站标题：</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="title" value="<?php echo ($web[0]['title']); ?>" />
                        </div>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="keyWords" value="<?php echo ($web[0]['keywords']); ?>" />
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    <div class="col-sm-2"></div>
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="description" value="<?php echo ($web[0]['description']); ?>" />
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    <div class="col-sm-2"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                                ...
                                <p class="help-block"><?php echo ($web[0]['webLogo']); ?></p>
                        </div>
                        <div class="col-sm-5"></div>
                    </div>
                    <div class="col-sm-5"></div>
