            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        ...
                        <span><i class="icon-table"> 用户管理</i>
                        <b style='float:right'>

                        <form action='/project/admin.php/User/index' method='get'>
                            <label>搜 索: <input aria-controls="DataTables_Table_0" name='userid' type="text" placeholder='输入要搜索的用户名' size=18></label>
                            <input type="submit" class="btn" value='搜索'>
                        </form>
                        
                        </b>
                        &nbsp;&nbsp;<a href="/project/admin.php/User/add" class="btn">添加用户</a>
                        ...
                        <table class="mws-table">
                            ...
                            <tbody style='text-align:center;'>
                                <?php if(is_array($user)): foreach($user as $key=>$user): ?><tr>
                                        ...
                                        <td>
                                            <?php if($user['status'] == 0 ): ?>超级管理员
                                            <?php elseif($user['status'] == 1): ?>管理员
                                            <?php elseif($user['status'] == 2): ?>客服
                                            <?php else: ?>技师<?php endif; ?>
                                        </td>
                                        
                                        <td><?php echo ($user['username']); ?></td>
                                        <td>
                                            <a href="/project/admin.php/User/edit/id/<?php echo ($user["id"]); ?>" class="btn">修改</a>
                                            <a href="/project/admin.php/User/del/id/<?php echo ($user["id"]); ?>" onclick="return confirm('你确定要删除吗？')" class="btn">删除</a>
                                        </td>
                                    </tr><?php endforeach; endif; ?>
                                <tr>
                                    
                                    <td colspan='5'>
                                        <div class="right"><?php echo ($show); ?></div>
                                    </td>
