            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table">4S列表</i><div style='float:right'><a href="/project/admin.php/Shop/add" class="btn"><i class="icol-accept" ></i>&nbsp;&nbsp;添加4S店</a></div></span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
                            ...
                            <tbody align='center'>
	                            <?php if(is_array($shop)): foreach($shop as $key=>$shop): ?><tr>
	                                    <td><?php echo ++$count;?></td>
                                        <td><?php echo ($shop["shopname"]); ?></td>
	                                    <td><?php echo ($shop["ofcity"]); ?></td>
	                                    <td>
	                                    <a href="/project/admin.php/Shop/mod/id/<?php echo ($shop["id"]); ?>/ofcity/<?php echo ($shop["ofcity"]); ?>/shopname/<?php echo ($shop["shopname"]); ?>" class="btn"><i class="icol-arrow-refresh"></i></a>
	                                    	<a href="/project/admin.php/Shop/del/id/<?php echo ($shop["id"]); ?>" onclick="return confirm('你确定要删除吗？')" class="btn"><i class="icol-cross"></i></a>
	                                    </td>
	                                </tr><?php endforeach; endif; ?>
                                    <tr>
                                        <td colspan='4'><span style='float:right'><?php echo ($show); ?></span>        
                                    </tr>
                            </tbody>
                        </table>
                    </div>
