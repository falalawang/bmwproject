            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/project/admin.php/Shop/save" method='post'>
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">4S店：</label>
                    				<div class="mws-form-item">
                    					<input type="text" class="small" name='shopname'>
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">所属城市：</label>
                    				<div class="mws-form-item">
                    					<select class="large" name='ofcity'>
                    						<?php if(is_array($city)): foreach($city as $key=>$city): ?><option value='<?php echo ($city["city"]); ?>'><?php echo ($city["city"]); ?></option><?php endforeach; endif; ?>
                    					</select>
                    				</div>
                    			</div>
                    		</div>
